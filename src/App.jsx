...
const PROJECTS = [
  ...
  { id: 3, title: "Medipass", descFr: "Hôpital digital — services médicaux, prise de RDV en ligne, UX rassurante. Projet de groupe IFRI.", descEn: "Digital hospital — medical services, online appointment booking. IFRI group project.", tags: ["Java", "HTML", "CSS", "JS"], type: "academic", github: "https://github.com/Chanis-ifri/Medipass", emoji: "🏥", color: "#1a7a5e" },
    ...
    <div style={{ fontFamily: "'Syne', sans-serif", background: bg, color: fg, minHeight: "100vh", transition: "background 0.4s, color 0.4s" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, background: navBg, backdropFilter: "blur(14px)", borderBottom: `1px solid ${dark ? "rgba(212,175,55,0.12)" : "rgba(0,0,0,0.08)"}`, padding: "0 2rem", display: "flex", alignItems: "center", justifyContent: "space-between", height: "62px" }}>
        ...
        <div style={{ display: "flex", gap: "0.1rem", alignItems: "center" }}>
          ...
          <a href="/CV_GaiusChanis_HONTONWAKOU.pdf" download style={{ background: "#d4af37", color: "#0d0d0d", border: "none", cursor: "pointer", padding: "0.4rem 0.85rem", borderRadius: "6px", fontSize: "0.78rem", fontWeight: 700, textDecoration: "none", marginLeft: "0.5rem" }}>
            {t.nav.cv}
          </a>
        ...
        <div style={{ flex: "1 1 380px" }}>
          ...
          <Reveal delay={0.5}>
            <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap", marginBottom: "2rem" }}>
              ...
              <a className="cta-outline" href="/CV_GaiusChanis_HONTONWAKOU.pdf" download style={{ background: "none", color: fg, border: `1px solid ${dark ? "rgba(255,255,255,0.2)" : "rgba(0,0,0,0.2)"}`, padding: "0.75rem 1.75rem", borderRadius: "8px", fontSize: "0.9rem", fontWeight: 600, textDecoration: "none", display: "inline-block" }}>{t.hero.cta2}</a>
            </div>
